...
bool crazyflie_interfaces__msg__full_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("crazyflie_interfaces.msg._full_state.FullState", full_classname_dest, 46) == 0);
  }
  crazyflie_interfaces__msg__FullState * ros_message = _ros_message;
  {  // header
...
PyObject * crazyflie_interfaces__msg__full_state__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("crazyflie_interfaces.msg._full_state");
