...
class Arm_Event(metaclass=Metaclass_Arm_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<crazyflie_interfaces/Arm_Request, 1>',
        'response': 'sequence<crazyflie_interfaces/Arm_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['crazyflie_interfaces', 'srv'], 'Arm_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['crazyflie_interfaces', 'srv'], 'Arm_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from crazyflie_interfaces.srv import Arm_Request
    ...
    def response(self, value):
        if self._check_fields:
            from crazyflie_interfaces.srv import Arm_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class Arm(metaclass=Metaclass_Arm):
    ...
    from crazyflie_interfaces.srv._arm import Arm_Event as Event
