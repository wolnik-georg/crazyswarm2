...
class Metaclass_UpdateParams_Event(type):
    """Metaclass of message 'UpdateParams_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__update_params__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__update_params__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__update_params__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__update_params__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__update_params__event
...
class UpdateParams_Event(metaclass=Metaclass_UpdateParams_Event):
    """Message class 'UpdateParams_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<crazyflie_interfaces/UpdateParams_Request, 1>',
        'response': 'sequence<crazyflie_interfaces/UpdateParams_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['crazyflie_interfaces', 'srv'], 'UpdateParams_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['crazyflie_interfaces', 'srv'], 'UpdateParams_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from crazyflie_interfaces.srv import UpdateParams_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, UpdateParams_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'UpdateParams_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from crazyflie_interfaces.srv import UpdateParams_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, UpdateParams_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'UpdateParams_Response'"
...
class Metaclass_UpdateParams(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _update_params.Metaclass_UpdateParams_Event._TYPE_SUPPORT is None:
                _update_params.Metaclass_UpdateParams_Event.__import_type_support__()
...
class UpdateParams(metaclass=Metaclass_UpdateParams):
    ...
    from crazyflie_interfaces.srv._update_params import UpdateParams_Event as Event
