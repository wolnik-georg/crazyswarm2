...
class Metaclass_SetGroupMask_Event(type):
    """Metaclass of message 'SetGroupMask_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__set_group_mask__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__set_group_mask__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__set_group_mask__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__set_group_mask__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__set_group_mask__event
...
class SetGroupMask_Event(metaclass=Metaclass_SetGroupMask_Event):
    """Message class 'SetGroupMask_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<crazyflie_interfaces/SetGroupMask_Request, 1>',
        'response': 'sequence<crazyflie_interfaces/SetGroupMask_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['crazyflie_interfaces', 'srv'], 'SetGroupMask_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['crazyflie_interfaces', 'srv'], 'SetGroupMask_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from crazyflie_interfaces.srv import SetGroupMask_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, SetGroupMask_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'SetGroupMask_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from crazyflie_interfaces.srv import SetGroupMask_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, SetGroupMask_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'SetGroupMask_Response'"
...
class Metaclass_SetGroupMask(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _set_group_mask.Metaclass_SetGroupMask_Event._TYPE_SUPPORT is None:
                _set_group_mask.Metaclass_SetGroupMask_Event.__import_type_support__()
...
class SetGroupMask(metaclass=Metaclass_SetGroupMask):
    ...
    from crazyflie_interfaces.srv._set_group_mask import SetGroupMask_Event as Event
