...
class Land_Event(metaclass=Metaclass_Land_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<crazyflie_interfaces/Land_Request, 1>',
        'response': 'sequence<crazyflie_interfaces/Land_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['crazyflie_interfaces', 'srv'], 'Land_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['crazyflie_interfaces', 'srv'], 'Land_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from crazyflie_interfaces.srv import Land_Request
    ...
    def response(self, value):
        if self._check_fields:
            from crazyflie_interfaces.srv import Land_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class Land(metaclass=Metaclass_Land):
    ...
    from crazyflie_interfaces.srv._land import Land_Event as Event
