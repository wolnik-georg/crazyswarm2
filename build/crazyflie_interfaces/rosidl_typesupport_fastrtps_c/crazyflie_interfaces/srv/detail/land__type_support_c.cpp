...
bool cdr_serialize_crazyflie_interfaces__srv__Land_Request(
  const crazyflie_interfaces__srv__Land_Request * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_crazyflie_interfaces
bool cdr_deserialize_crazyflie_interfaces__srv__Land_Request(
  eprosima::fastcdr::Cdr & cdr,
  crazyflie_interfaces__srv__Land_Request * ros_message)
{
  // Field name: group_mask
  {
    cdr >> ros_message->group_mask;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_crazyflie_interfaces
bool cdr_serialize_key_crazyflie_interfaces__srv__Land_Request(
  const crazyflie_interfaces__srv__Land_Request * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: group_mask
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_crazyflie_interfaces
size_t get_serialized_size_key_crazyflie_interfaces__srv__Land_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Land_Request__ros_msg_type * ros_message = static_cast<const _Land_Request__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_crazyflie_interfaces
size_t max_serialized_size_key_crazyflie_interfaces__srv__Land_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const crazyflie_interfaces__srv__Land_Request * ros_message = static_cast<const crazyflie_interfaces__srv__Land_Request *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_crazyflie_interfaces__srv__Land_Request(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  crazyflie_interfaces__srv__Land_Request * ros_message = static_cast<crazyflie_interfaces__srv__Land_Request *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_crazyflie_interfaces__srv__Land_Request(cdr, ros_message);
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_crazyflie_interfaces
bool cdr_serialize_crazyflie_interfaces__srv__Land_Response(
  const crazyflie_interfaces__srv__Land_Response * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_crazyflie_interfaces
bool cdr_deserialize_crazyflie_interfaces__srv__Land_Response(
  eprosima::fastcdr::Cdr & cdr,
  crazyflie_interfaces__srv__Land_Response * ros_message)
{
  // Field name: structure_needs_at_least_one_member
  {
    cdr >> ros_message->structure_needs_at_least_one_member;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_crazyflie_interfaces
bool cdr_serialize_key_crazyflie_interfaces__srv__Land_Response(
  const crazyflie_interfaces__srv__Land_Response * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: structure_needs_at_least_one_member
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_crazyflie_interfaces
size_t get_serialized_size_key_crazyflie_interfaces__srv__Land_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Land_Response__ros_msg_type * ros_message = static_cast<const _Land_Response__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_crazyflie_interfaces
size_t max_serialized_size_key_crazyflie_interfaces__srv__Land_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const crazyflie_interfaces__srv__Land_Response * ros_message = static_cast<const crazyflie_interfaces__srv__Land_Response *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_crazyflie_interfaces__srv__Land_Response(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  crazyflie_interfaces__srv__Land_Response * ros_message = static_cast<crazyflie_interfaces__srv__Land_Response *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_crazyflie_interfaces__srv__Land_Response(cdr, ros_message);
}
...
using _Land_Event__ros_msg_type = crazyflie_interfaces__srv__Land_Event;


ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_crazyflie_interfaces
bool cdr_serialize_crazyflie_interfaces__srv__Land_Event(
  const crazyflie_interfaces__srv__Land_Event * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: info
  {
  ...
  // Field name: request
  {
    ...
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_crazyflie_interfaces__srv__Land_Request(
        &array_ptr[i], cdr);
    }
  }
  ...
  // Field name: response
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_crazyflie_interfaces__srv__Land_Response(
        &array_ptr[i], cdr);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_crazyflie_interfaces
bool cdr_deserialize_crazyflie_interfaces__srv__Land_Event(
  eprosima::fastcdr::Cdr & cdr,
  crazyflie_interfaces__srv__Land_Event * ros_message)
{
  // Field name: info
  {
  ...
  // Field name: request
  {
    ...
    if (ros_message->request.data) {
      crazyflie_interfaces__srv__Land_Request__Sequence__fini(&ros_message->request);
    }
    if (!crazyflie_interfaces__srv__Land_Request__Sequence__init(&ros_message->request, size)) {
      fprintf(stderr, "failed to create array for field 'request'");
      return false;
    }
    auto array_ptr = ros_message->request.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_crazyflie_interfaces__srv__Land_Request(cdr, &array_ptr[i]);
    }
  }
  ...
  // Field name: response
  {
    ...
    if (ros_message->response.data) {
      crazyflie_interfaces__srv__Land_Response__Sequence__fini(&ros_message->response);
    }
    if (!crazyflie_interfaces__srv__Land_Response__Sequence__init(&ros_message->response, size)) {
      fprintf(stderr, "failed to create array for field 'response'");
      return false;
    }
    auto array_ptr = ros_message->response.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_crazyflie_interfaces__srv__Land_Response(cdr, &array_ptr[i]);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_crazyflie_interfaces
size_t get_serialized_size_crazyflie_interfaces__srv__Land_Event(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  ...
  // Field name: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_crazyflie_interfaces__srv__Land_Request(
  ...
  // Field name: response
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_crazyflie_interfaces__srv__Land_Response(
        &array_ptr[index], current_alignment);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_crazyflie_interfaces
size_t max_serialized_size_crazyflie_interfaces__srv__Land_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Field name: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_crazyflie_interfaces__srv__Land_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Field name: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_crazyflie_interfaces__srv__Land_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = crazyflie_interfaces__srv__Land_Event;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_crazyflie_interfaces
bool cdr_serialize_key_crazyflie_interfaces__srv__Land_Event(
  const crazyflie_interfaces__srv__Land_Event * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: info
  ...
  // Field name: request
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_crazyflie_interfaces__srv__Land_Request(
        &array_ptr[i], cdr);
    }
  }
  ...
  // Field name: response
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_crazyflie_interfaces__srv__Land_Response(
        &array_ptr[i], cdr);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_crazyflie_interfaces
size_t get_serialized_size_key_crazyflie_interfaces__srv__Land_Event(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Land_Event__ros_msg_type * ros_message = static_cast<const _Land_Event__ros_msg_type *>(untyped_ros_message);
  ...
  // Field name: request
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_crazyflie_interfaces__srv__Land_Request(
        &array_ptr[index], current_alignment);
    }
  }
  ...
  // Field name: response
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_crazyflie_interfaces__srv__Land_Response(
        &array_ptr[index], current_alignment);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_crazyflie_interfaces
size_t max_serialized_size_key_crazyflie_interfaces__srv__Land_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Field name: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_crazyflie_interfaces__srv__Land_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Field name: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_crazyflie_interfaces__srv__Land_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const crazyflie_interfaces__srv__Land_Event * ros_message = static_cast<const crazyflie_interfaces__srv__Land_Event *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_crazyflie_interfaces__srv__Land_Event(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  crazyflie_interfaces__srv__Land_Event * ros_message = static_cast<crazyflie_interfaces__srv__Land_Event *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_crazyflie_interfaces__srv__Land_Event(cdr, ros_message);
}

static uint32_t _Land_Event__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_crazyflie_interfaces__srv__Land_Event(
      untyped_ros_message, 0));
}
...
static size_t _Land_Event__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_crazyflie_interfaces__srv__Land_Event(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, crazyflie_interfaces, srv, Land_Event)() {
