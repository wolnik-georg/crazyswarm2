  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const crazyflie_interfaces__msg__LogDataGeneric * ros_message = static_cast<const crazyflie_interfaces__msg__LogDataGeneric *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_crazyflie_interfaces__msg__LogDataGeneric(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  crazyflie_interfaces__msg__LogDataGeneric * ros_message = static_cast<crazyflie_interfaces__msg__LogDataGeneric *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_crazyflie_interfaces__msg__LogDataGeneric(cdr, ros_message);
}
