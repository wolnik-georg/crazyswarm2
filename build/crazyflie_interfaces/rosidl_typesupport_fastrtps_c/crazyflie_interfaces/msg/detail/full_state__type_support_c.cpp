  ...
  crazyflie_interfaces__msg__FullState * ros_message)
{
  ...
  // Field name: acc
  {
    cdr_deserialize_geometry_msgs__msg__Vector3(cdr, &ros_message->acc);
  }
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const crazyflie_interfaces__msg__FullState * ros_message = static_cast<const crazyflie_interfaces__msg__FullState *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_crazyflie_interfaces__msg__FullState(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  crazyflie_interfaces__msg__FullState * ros_message = static_cast<crazyflie_interfaces__msg__FullState *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_crazyflie_interfaces__msg__FullState(cdr, ros_message);
}
