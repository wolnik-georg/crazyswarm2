...
crazyflie_interfaces__srv__UpdateParams_Event__init(crazyflie_interfaces__srv__UpdateParams_Event * msg)
{
  ...
  if (!service_msgs__msg__ServiceEventInfo__init(&msg->info)) {
    crazyflie_interfaces__srv__UpdateParams_Event__fini(msg);
    return false;
  }
  // request
  if (!crazyflie_interfaces__srv__UpdateParams_Request__Sequence__init(&msg->request, 0)) {
    crazyflie_interfaces__srv__UpdateParams_Event__fini(msg);
    return false;
  }
  // response
  if (!crazyflie_interfaces__srv__UpdateParams_Response__Sequence__init(&msg->response, 0)) {
    crazyflie_interfaces__srv__UpdateParams_Event__fini(msg);
    return false;
  }
  return true;
...
crazyflie_interfaces__srv__UpdateParams_Event__fini(crazyflie_interfaces__srv__UpdateParams_Event * msg)
{
  ...
  // request
  crazyflie_interfaces__srv__UpdateParams_Request__Sequence__fini(&msg->request);
  // response
  crazyflie_interfaces__srv__UpdateParams_Response__Sequence__fini(&msg->response);
}
...
crazyflie_interfaces__srv__UpdateParams_Event__are_equal(const crazyflie_interfaces__srv__UpdateParams_Event * lhs, const crazyflie_interfaces__srv__UpdateParams_Event * rhs)
{
  ...
  // request
  if (!crazyflie_interfaces__srv__UpdateParams_Request__Sequence__are_equal(
      &(lhs->request), &(rhs->request)))
  {
    return false;
  }
  // response
  if (!crazyflie_interfaces__srv__UpdateParams_Response__Sequence__are_equal(
  ...
  crazyflie_interfaces__srv__UpdateParams_Event * output)
{
  ...
  // request
  if (!crazyflie_interfaces__srv__UpdateParams_Request__Sequence__copy(
      &(input->request), &(output->request)))
  {
    return false;
  }
  // response
  if (!crazyflie_interfaces__srv__UpdateParams_Response__Sequence__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  crazyflie_interfaces__srv__UpdateParams_Event * msg = (crazyflie_interfaces__srv__UpdateParams_Event *)allocator.allocate(sizeof(crazyflie_interfaces__srv__UpdateParams_Event), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(crazyflie_interfaces__srv__UpdateParams_Event));
  bool success = crazyflie_interfaces__srv__UpdateParams_Event__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
crazyflie_interfaces__srv__UpdateParams_Event__Sequence__init(crazyflie_interfaces__srv__UpdateParams_Event__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  crazyflie_interfaces__srv__UpdateParams_Event * data = NULL;

  if (size) {
    data = (crazyflie_interfaces__srv__UpdateParams_Event *)allocator.zero_allocate(size, sizeof(crazyflie_interfaces__srv__UpdateParams_Event), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = crazyflie_interfaces__srv__UpdateParams_Event__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        crazyflie_interfaces__srv__UpdateParams_Event__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
crazyflie_interfaces__srv__UpdateParams_Event__Sequence__fini(crazyflie_interfaces__srv__UpdateParams_Event__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      crazyflie_interfaces__srv__UpdateParams_Event__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  crazyflie_interfaces__srv__UpdateParams_Event__Sequence * array = (crazyflie_interfaces__srv__UpdateParams_Event__Sequence *)allocator.allocate(sizeof(crazyflie_interfaces__srv__UpdateParams_Event__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = crazyflie_interfaces__srv__UpdateParams_Event__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
crazyflie_interfaces__srv__UpdateParams_Event__Sequence__destroy(crazyflie_interfaces__srv__UpdateParams_Event__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    crazyflie_interfaces__srv__UpdateParams_Event__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
crazyflie_interfaces__srv__UpdateParams_Event__Sequence__are_equal(const crazyflie_interfaces__srv__UpdateParams_Event__Sequence * lhs, const crazyflie_interfaces__srv__UpdateParams_Event__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!crazyflie_interfaces__srv__UpdateParams_Event__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  crazyflie_interfaces__srv__UpdateParams_Event__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(crazyflie_interfaces__srv__UpdateParams_Event);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    crazyflie_interfaces__srv__UpdateParams_Event * data =
      (crazyflie_interfaces__srv__UpdateParams_Event *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!crazyflie_interfaces__srv__UpdateParams_Event__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          crazyflie_interfaces__srv__UpdateParams_Event__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!crazyflie_interfaces__srv__UpdateParams_Event__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
