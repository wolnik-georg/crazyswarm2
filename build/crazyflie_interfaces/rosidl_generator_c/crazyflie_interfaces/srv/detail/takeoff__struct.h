...
enum
{
  crazyflie_interfaces__srv__Takeoff_Event__request__MAX_SIZE = 1
};
// response
enum
{
  crazyflie_interfaces__srv__Takeoff_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/Takeoff in the package crazyflie_interfaces.
typedef struct crazyflie_interfaces__srv__Takeoff_Event
{
  service_msgs__msg__ServiceEventInfo info;
  crazyflie_interfaces__srv__Takeoff_Request__Sequence request;
  crazyflie_interfaces__srv__Takeoff_Response__Sequence response;
} crazyflie_interfaces__srv__Takeoff_Event;

// Struct for a sequence of crazyflie_interfaces__srv__Takeoff_Event.
typedef struct crazyflie_interfaces__srv__Takeoff_Event__Sequence
{
