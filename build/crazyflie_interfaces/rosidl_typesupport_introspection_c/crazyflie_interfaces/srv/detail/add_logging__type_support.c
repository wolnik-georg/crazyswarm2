...
void crazyflie_interfaces__srv__AddLogging_Event__rosidl_typesupport_introspection_c__AddLogging_Event_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  crazyflie_interfaces__srv__AddLogging_Event__init(message_memory);
}

void crazyflie_interfaces__srv__AddLogging_Event__rosidl_typesupport_introspection_c__AddLogging_Event_fini_function(void * message_memory)
{
  crazyflie_interfaces__srv__AddLogging_Event__fini(message_memory);
}

size_t crazyflie_interfaces__srv__AddLogging_Event__rosidl_typesupport_introspection_c__size_function__AddLogging_Event__request(
  const void * untyped_member)
{
  const crazyflie_interfaces__srv__AddLogging_Request__Sequence * member =
    (const crazyflie_interfaces__srv__AddLogging_Request__Sequence *)(untyped_member);
  return member->size;
}

const void * crazyflie_interfaces__srv__AddLogging_Event__rosidl_typesupport_introspection_c__get_const_function__AddLogging_Event__request(
  const void * untyped_member, size_t index)
{
  const crazyflie_interfaces__srv__AddLogging_Request__Sequence * member =
    (const crazyflie_interfaces__srv__AddLogging_Request__Sequence *)(untyped_member);
...
void * crazyflie_interfaces__srv__AddLogging_Event__rosidl_typesupport_introspection_c__get_function__AddLogging_Event__request(
  void * untyped_member, size_t index)
{
  crazyflie_interfaces__srv__AddLogging_Request__Sequence * member =
    (crazyflie_interfaces__srv__AddLogging_Request__Sequence *)(untyped_member);
  return &member->data[index];
}

void crazyflie_interfaces__srv__AddLogging_Event__rosidl_typesupport_introspection_c__fetch_function__AddLogging_Event__request(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const crazyflie_interfaces__srv__AddLogging_Request * item =
    ((const crazyflie_interfaces__srv__AddLogging_Request *)
    crazyflie_interfaces__srv__AddLogging_Event__rosidl_typesupport_introspection_c__get_const_function__AddLogging_Event__request(untyped_member, index));
  crazyflie_interfaces__srv__AddLogging_Request * value =
    (crazyflie_interfaces__srv__AddLogging_Request *)(untyped_value);
  *value = *item;
}

void crazyflie_interfaces__srv__AddLogging_Event__rosidl_typesupport_introspection_c__assign_function__AddLogging_Event__request(
  void * untyped_member, size_t index, const void * untyped_value)
{
  crazyflie_interfaces__srv__AddLogging_Request * item =
    ((crazyflie_interfaces__srv__AddLogging_Request *)
    crazyflie_interfaces__srv__AddLogging_Event__rosidl_typesupport_introspection_c__get_function__AddLogging_Event__request(untyped_member, index));
  const crazyflie_interfaces__srv__AddLogging_Request * value =
    (const crazyflie_interfaces__srv__AddLogging_Request *)(untyped_value);
  *item = *value;
}

bool crazyflie_interfaces__srv__AddLogging_Event__rosidl_typesupport_introspection_c__resize_function__AddLogging_Event__request(
  void * untyped_member, size_t size)
{
  crazyflie_interfaces__srv__AddLogging_Request__Sequence * member =
    (crazyflie_interfaces__srv__AddLogging_Request__Sequence *)(untyped_member);
  crazyflie_interfaces__srv__AddLogging_Request__Sequence__fini(member);
  return crazyflie_interfaces__srv__AddLogging_Request__Sequence__init(member, size);
}

size_t crazyflie_interfaces__srv__AddLogging_Event__rosidl_typesupport_introspection_c__size_function__AddLogging_Event__response(
  const void * untyped_member)
{
  const crazyflie_interfaces__srv__AddLogging_Response__Sequence * member =
    (const crazyflie_interfaces__srv__AddLogging_Response__Sequence *)(untyped_member);
  return member->size;
}

const void * crazyflie_interfaces__srv__AddLogging_Event__rosidl_typesupport_introspection_c__get_const_function__AddLogging_Event__response(
  const void * untyped_member, size_t index)
{
  const crazyflie_interfaces__srv__AddLogging_Response__Sequence * member =
    (const crazyflie_interfaces__srv__AddLogging_Response__Sequence *)(untyped_member);
...
void * crazyflie_interfaces__srv__AddLogging_Event__rosidl_typesupport_introspection_c__get_function__AddLogging_Event__response(
  void * untyped_member, size_t index)
{
  crazyflie_interfaces__srv__AddLogging_Response__Sequence * member =
    (crazyflie_interfaces__srv__AddLogging_Response__Sequence *)(untyped_member);
  return &member->data[index];
}

void crazyflie_interfaces__srv__AddLogging_Event__rosidl_typesupport_introspection_c__fetch_function__AddLogging_Event__response(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const crazyflie_interfaces__srv__AddLogging_Response * item =
    ((const crazyflie_interfaces__srv__AddLogging_Response *)
    crazyflie_interfaces__srv__AddLogging_Event__rosidl_typesupport_introspection_c__get_const_function__AddLogging_Event__response(untyped_member, index));
  crazyflie_interfaces__srv__AddLogging_Response * value =
    (crazyflie_interfaces__srv__AddLogging_Response *)(untyped_value);
  *value = *item;
}

void crazyflie_interfaces__srv__AddLogging_Event__rosidl_typesupport_introspection_c__assign_function__AddLogging_Event__response(
  void * untyped_member, size_t index, const void * untyped_value)
{
  crazyflie_interfaces__srv__AddLogging_Response * item =
    ((crazyflie_interfaces__srv__AddLogging_Response *)
    crazyflie_interfaces__srv__AddLogging_Event__rosidl_typesupport_introspection_c__get_function__AddLogging_Event__response(untyped_member, index));
  const crazyflie_interfaces__srv__AddLogging_Response * value =
    (const crazyflie_interfaces__srv__AddLogging_Response *)(untyped_value);
  *item = *value;
}

bool crazyflie_interfaces__srv__AddLogging_Event__rosidl_typesupport_introspection_c__resize_function__AddLogging_Event__response(
  void * untyped_member, size_t size)
{
  crazyflie_interfaces__srv__AddLogging_Response__Sequence * member =
    (crazyflie_interfaces__srv__AddLogging_Response__Sequence *)(untyped_member);
  crazyflie_interfaces__srv__AddLogging_Response__Sequence__fini(member);
  return crazyflie_interfaces__srv__AddLogging_Response__Sequence__init(member, size);
}

static rosidl_typesupport_introspection_c__MessageMember crazyflie_interfaces__srv__AddLogging_Event__rosidl_typesupport_introspection_c__AddLogging_Event_message_member_array[3] = {
  {
    "info",  // name
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(crazyflie_interfaces__srv__AddLogging_Event, info),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    1,  // array size
    true,  // is upper bound
    offsetof(crazyflie_interfaces__srv__AddLogging_Event, request),  // bytes offset in struct
    NULL,  // default value
    crazyflie_interfaces__srv__AddLogging_Event__rosidl_typesupport_introspection_c__size_function__AddLogging_Event__request,  // size() function pointer
    crazyflie_interfaces__srv__AddLogging_Event__rosidl_typesupport_introspection_c__get_const_function__AddLogging_Event__request,  // get_const(index) function pointer
    crazyflie_interfaces__srv__AddLogging_Event__rosidl_typesupport_introspection_c__get_function__AddLogging_Event__request,  // get(index) function pointer
    crazyflie_interfaces__srv__AddLogging_Event__rosidl_typesupport_introspection_c__fetch_function__AddLogging_Event__request,  // fetch(index, &value) function pointer
    crazyflie_interfaces__srv__AddLogging_Event__rosidl_typesupport_introspection_c__assign_function__AddLogging_Event__request,  // assign(index, value) function pointer
    crazyflie_interfaces__srv__AddLogging_Event__rosidl_typesupport_introspection_c__resize_function__AddLogging_Event__request  // resize(index) function pointer
  },
  {
    "response",  // name
    rosidl_typesupport_introspection_c__ROS_TYPE_MESSAGE,  // type
    ...
    1,  // array size
    true,  // is upper bound
    offsetof(crazyflie_interfaces__srv__AddLogging_Event, response),  // bytes offset in struct
    NULL,  // default value
    crazyflie_interfaces__srv__AddLogging_Event__rosidl_typesupport_introspection_c__size_function__AddLogging_Event__response,  // size() function pointer
    crazyflie_interfaces__srv__AddLogging_Event__rosidl_typesupport_introspection_c__get_const_function__AddLogging_Event__response,  // get_const(index) function pointer
    crazyflie_interfaces__srv__AddLogging_Event__rosidl_typesupport_introspection_c__get_function__AddLogging_Event__response,  // get(index) function pointer
    crazyflie_interfaces__srv__AddLogging_Event__rosidl_typesupport_introspection_c__fetch_function__AddLogging_Event__response,  // fetch(index, &value) function pointer
    crazyflie_interfaces__srv__AddLogging_Event__rosidl_typesupport_introspection_c__assign_function__AddLogging_Event__response,  // assign(index, value) function pointer
    crazyflie_interfaces__srv__AddLogging_Event__rosidl_typesupport_introspection_c__resize_function__AddLogging_Event__response  // resize(index) function pointer
  }
};

static const rosidl_typesupport_introspection_c__MessageMembers crazyflie_interfaces__srv__AddLogging_Event__rosidl_typesupport_introspection_c__AddLogging_Event_message_members = {
  "crazyflie_interfaces__srv",  // message namespace
  "AddLogging_Event",  // message name
  3,  // number of fields
  sizeof(crazyflie_interfaces__srv__AddLogging_Event),
  false,  // has_any_key_member_
  crazyflie_interfaces__srv__AddLogging_Event__rosidl_typesupport_introspection_c__AddLogging_Event_message_member_array,  // message members
  crazyflie_interfaces__srv__AddLogging_Event__rosidl_typesupport_introspection_c__AddLogging_Event_init_function,  // function to initialize message memory (memory has to be allocated)
  crazyflie_interfaces__srv__AddLogging_Event__rosidl_typesupport_introspection_c__AddLogging_Event_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t crazyflie_interfaces__srv__AddLogging_Event__rosidl_typesupport_introspection_c__AddLogging_Event_message_type_support_handle = {
  0,
  &crazyflie_interfaces__srv__AddLogging_Event__rosidl_typesupport_introspection_c__AddLogging_Event_message_members,
  get_message_typesupport_handle_function,
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_crazyflie_interfaces
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, crazyflie_interfaces, srv, AddLogging_Event)() {
  crazyflie_interfaces__srv__AddLogging_Event__rosidl_typesupport_introspection_c__AddLogging_Event_message_member_array[0].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, service_msgs, msg, ServiceEventInfo)();
  crazyflie_interfaces__srv__AddLogging_Event__rosidl_typesupport_introspection_c__AddLogging_Event_message_member_array[1].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, crazyflie_interfaces, srv, AddLogging_Request)();
  crazyflie_interfaces__srv__AddLogging_Event__rosidl_typesupport_introspection_c__AddLogging_Event_message_member_array[2].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, crazyflie_interfaces, srv, AddLogging_Response)();
  if (!crazyflie_interfaces__srv__AddLogging_Event__rosidl_typesupport_introspection_c__AddLogging_Event_message_type_support_handle.typesupport_identifier) {
    crazyflie_interfaces__srv__AddLogging_Event__rosidl_typesupport_introspection_c__AddLogging_Event_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &crazyflie_interfaces__srv__AddLogging_Event__rosidl_typesupport_introspection_c__AddLogging_Event_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
...
static rosidl_service_type_support_t crazyflie_interfaces__srv__detail__add_logging__rosidl_typesupport_introspection_c__AddLogging_service_type_support_handle = {
  ...
  &crazyflie_interfaces__srv__AddLogging_Request__rosidl_typesupport_introspection_c__AddLogging_Request_message_type_support_handle,
  &crazyflie_interfaces__srv__AddLogging_Response__rosidl_typesupport_introspection_c__AddLogging_Response_message_type_support_handle,
  &crazyflie_interfaces__srv__AddLogging_Event__rosidl_typesupport_introspection_c__AddLogging_Event_message_type_support_handle,
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, crazyflie_interfaces, srv, AddLogging_Request)(void);

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, crazyflie_interfaces, srv, AddLogging_Response)(void);

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, crazyflie_interfaces, srv, AddLogging_Event)(void);

ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_crazyflie_interfaces
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, crazyflie_interfaces, srv, AddLogging)(void) {
  ...
  if (!service_members->event_members_) {
    service_members->event_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, crazyflie_interfaces, srv, AddLogging_Event)()->data;
  }
