...
static const _Takeoff_Event_type_support_symbol_names_t _Takeoff_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, crazyflie_interfaces, srv, Takeoff_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, crazyflie_interfaces, srv, Takeoff_Event)),
  }
};
...
{
  return &::crazyflie_interfaces::srv::rosidl_typesupport_cpp::Takeoff_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, crazyflie_interfaces, srv, Takeoff_Event)() {
  return get_message_type_support_handle<crazyflie_interfaces::srv::Takeoff_Event>();
}
...
static const rosidl_service_type_support_t Takeoff_service_type_support_handle = {
  ...
  ::rosidl_typesupport_cpp::get_message_type_support_handle<crazyflie_interfaces::srv::Takeoff_Request>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<crazyflie_interfaces::srv::Takeoff_Response>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<crazyflie_interfaces::srv::Takeoff_Event>(),
