...
static const _UploadTrajectory_Event_type_support_symbol_names_t _UploadTrajectory_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, crazyflie_interfaces, srv, UploadTrajectory_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, crazyflie_interfaces, srv, UploadTrajectory_Event)),
  }
};
...
{
  return &::crazyflie_interfaces::srv::rosidl_typesupport_cpp::UploadTrajectory_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, crazyflie_interfaces, srv, UploadTrajectory_Event)() {
  return get_message_type_support_handle<crazyflie_interfaces::srv::UploadTrajectory_Event>();
}
...
static const rosidl_service_type_support_t UploadTrajectory_service_type_support_handle = {
  ...
  ::rosidl_typesupport_cpp::get_message_type_support_handle<crazyflie_interfaces::srv::UploadTrajectory_Request>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<crazyflie_interfaces::srv::UploadTrajectory_Response>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<crazyflie_interfaces::srv::UploadTrajectory_Event>(),
